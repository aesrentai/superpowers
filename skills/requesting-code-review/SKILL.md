...
Dispatch a code-reviewer subagent to catch concrete issues at meaningful checkpoints. The reviewer gets precisely crafted context for evaluation — never your session's history. This keeps the reviewer focused on the work product, not your thought process, and preserves your own context for continued work.
...
Use the code-reviewer agent when available. If not, dispatch a worker-style subagent and fill the template at `code-reviewer.md`.
