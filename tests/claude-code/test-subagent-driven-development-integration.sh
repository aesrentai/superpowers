...
echo "  4. Spec compliance review after implementation"
...
4. Run spec compliance review after implementation
...
if [ $FAILED -eq 0 ]; then
    ...
    echo "  ✓ Runs spec compliance review after implementation"
